    ...
    public override void Move()
    {
        ...
        switch (m_aiState)
        {
            ...
            case AIState.Wait:
                ...
                transform.rotation = Quaternion.Euler(transform.rotation.eulerAngles.x, NextPatrolPoint().transform.rotation.eulerAngles.y + Mathf.Sin(m_lookAround) * Mathf.Rad2Deg, transform.rotation.eulerAngles.z);
                if (m_waitTime <= 0)
                {
